...
$pdf->SetFont("Arial", "", 7); //tamaño de letra de los resultados de la tabla
...
$rece =("SELECT a.num_receta, a.fecha_receta, a.dni_afi, a.mp_med, b.dni, b.nombre as nom_afi, b.apellido as ape_afi, c.mp, c.nombre
	             FROM recetas a
...
$rece =("SELECT a.cantidad, a.troquel, a.precio, b.troquel, b.medicamento, b.presentacion
	             ...
	             WHERE a.num_receta = '$num_receta' AND b.estado = 1");
$r = mysqli_query($conexion,$rece);
...
$pdf->Ln(4);
$pdf->SetFont("Arial", '', 7);
$pdf->Cell(10, 3,  ''.$row2['cantidad'], 1, 0, 'C',0);
$pdf->Cell(50, 3,  ''.$row2['medicamento'], 1, 0, 'C',0);
$pdf->Cell(20, 3,  ''.$row2['presentacion'], 1, 0, 'C',0);
}
}
$pdf->Ln(5);
$pdf->SetFont("Arial", "", 7);
...
$pdf->Cell(50, 3,  ''.$row2['medicamento'], 1, 0, 'C',0);
$pdf->Cell(20, 3,  ''.$row2['presentacion'], 1, 0, 'C',0);
$pdf->Cell(30, 3,              '$ '.$row2['precio'], 1, 0, 'L',0);
}
$pdf->Ln(7);
include("inc/conexion.php");
