...
if ($zip->open($tmpZipFile) === TRUE) {
    ...
    exit();
        ...
        echo "Borrando tabla \n";
        mysqli_query($conexion,"TRUNCATE TABLE alfabeta_articulos_novedades");        
        echo "Tabla borrada \n";
