...
if ($zip->open($tmpZipFile) === TRUE) {
    ...
    if($datosTxt == null){
        ...
        foreach ($xml_obj->basecompleta->Laborato->registro as $registro) {
echo $registro->id.' '.$registro->des.'<br>';
            mysqli_query($conexion,"INSERT INTO `alfabeta_laboratorios` (`id`, `des`) VALUES ('$registro->id', '$registro->des');");
