...
if(is_null($_GET["periodo"])){
        ...
        $sql = "SELECT a.num_receta, a.fecha_alta, b.fecha_receta, b.mp_med, b.dni_afi, c.cantidad, c.precio, d.medicamento, d.presentacion, e.nombre, f.nombre as nom, f.apellido as ape, g.farmacia, f.diagnostico, c.troquel, h.periodo, a.dia, a.hora, a.minuto, a.ano, a.mes
                                  FROM validaciones a 
                                  LEFT JOIN recetas b 
