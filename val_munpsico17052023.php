...
fwrite($logFile, "\n".date("d/m/Y H:i:s")." Consulta Receta: ".$cuit.' / '.$idsucursal.' - '.$ip_add.' | '.$nro_receta_.' - '.$dni ) or die("Error escribiendo en el archivo");fclose($logFile);
	...
	$medi =("SELECT  FROM vade_psicotropicos WHERE troquel = '$troquel' AND estado = 1");
?>
<div class="card">
	...
	<!--<a href="val_munpsicoman.php"><button type="button"  class="btn btn-danger"><i class="icon-copy"></i> Receta Manual</button></a>-->			
		...
		<hr>
			<div class="row">
			<form name="form1" method="POST" action="val_munpsico17052023.php" id="cdr">
				...
				<label class="col-form-label col-lg-6">Buscar por DNI y Nro Receta (Hasta el -)</label>
					<div class="col-lg-12">
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="" id="nro_receta_" name="nro_receta_" required>
							<span class="input-group-prepend">
	...
	<div class="card">
								            ...
								            <div class="card">
								                <div class="card-body">
												    ...
												    <tr>
												      ...
												      <td colspan="1" width="20%"><b>MARCA</b></td>
													...
													if($sigla_os == 'MUNI-X-CBA'){
														...
														echo "<td colspan='1' width='3%'><FONT COLOR='red'>FUERA DE VADEMECUM | $item->nombrecomercial $item->value $item->currency";
														echo "<td colspan='1' width='3%'>$presentacion";
														echo "<td colspan='1' width='3%'>$marca";
														...
														echo "<tr>";
														echo "<td colspan='1' width='3%'><input name='cantidad[]' id='cantidad' value='".$cant_prescripta."'>";
														echo "<td colspan='1' width='3%'>$item->nombrecomercial $item->value $item->currency";
														echo "<td colspan='1' width='3%'>$presentacion";
														echo "<td colspan='1' width='3%'>$marca";
														echo "<td colspan='1' width='3%'>$precio";
														echo"<input type='hidden' name='troquel[]' id='troquel' value='".$troquel."'>";
		...
		';} 
		?>
	    <input type="hidden" name="nro_receta" value="<?php echo $nro_receta_ ?>">
